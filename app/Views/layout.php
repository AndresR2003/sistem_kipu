            ...
            <div class="chat-main" id="chatMain">
                ...
                <div class="chat-composer">
                    <div class="chat-attachment-preview" id="chatAttachmentPreview">
                        <i class="bi bi-paperclip ani-sacudir"></i><span id="chatAttachmentName"></span>
                    ...
                    <form id="chatForm" enctype="multipart/form-data">
                        <div class="chat-input-row">
                            ...
                            <button class="chat-tool" id="chatFileButton" type="button" title="Adjuntar archivo" aria-label="Adjuntar archivo"><i class="bi bi-paperclip ani-sacudir"></i></button>
                            ...
                            <button class="chat-send" id="chatSend" type="submit" title="Enviar mensaje" aria-label="Enviar mensaje"><i class="bi bi-send ani-mover"></i></button>
                        </div>
                    </form>
                </div>
            </div>
