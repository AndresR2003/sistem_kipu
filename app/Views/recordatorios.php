...
.pub-card.completado{opacity:0.55;}
.pub-card.completado .pub-titulo{text-decoration:line-through;color:var(--text-muted);}
.pub-card.completado .pub-contenido{text-decoration:line-through;color:var(--text-muted);}
...
.noticia-card.completado{opacity:0.55;}
.noticia-card.completado .pub-titulo,.noticia-card.completado .pub-contenido{text-decoration:line-through;color:var(--text-muted);}
