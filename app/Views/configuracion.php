        ...
        <div class="col-lg-5">
            <div class="card" style="background:var(--bg-card);border:1px solid var(--border);border-radius:var(--radius);padding:24px;position:sticky;top:84px;">
                ...
                <div style="border:1px solid var(--border);border-radius:var(--radius-sm);overflow:hidden;">
                    <div id="previewTopbar" style="background:rgba(15,15,26,0.92);padding:10px 14px;display:flex;justify-content:space-between;align-items:center;">
                    ...
                    <div style="display:flex;">
                        <div id="previewSidebar" style="background:#13131f;width:60px;padding:12px 8px;display:flex;flex-direction:column;align-items:center;gap:12px;">
                            <div style="width:28px;height:28px;border-radius:6px;background:#4669FA;display:flex;align-items:center;justify-content:center;color:#fff;font-size:0.75rem;">
                        ...
                        <div style="flex:1;background:#0f0f1a;padding:14px;">
                            <div style="height:8px;width:60%;background:rgba(255,255,255,0.06);border-radius:4px;margin-bottom:8px;"></div>
                            <div style="height:8px;width:40%;background:rgba(255,255,255,0.04);border-radius:4px;margin-bottom:12px;"></div>
                            <div style="display:flex;gap:8px;">
                                <div style="flex:1;height:50px;background:rgba(255,255,255,0.03);border-radius:8px;"></div>
                                <div style="flex:1;height:50px;background:rgba(255,255,255,0.03);border-radius:8px;"></div>
                            </div>
                        </div>
                    </div>
